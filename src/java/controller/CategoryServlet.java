...
public class CategoryServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        String r_idCategory = request.getParameter("idCategory");
        ...
        if (sortPrice!=null){
            if(sortPrice.equals("asc")) sort = "asc";
            else sort = "desc";
        ...
        int idCategory = Integer.parseInt(r_idCategory);
        DAO dao = new DAO();
        
        List<Product> product = dao.getProductByCategory(idCategory,types, brands, colors, from, to, sort);
        // all category
