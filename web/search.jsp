                        ...
                        <div class="home-sort-bar">
                            ...
                            <div class="sort-price">
                                ...
                                <ul class="sort-price__list">
                                    <li class="sort-price__item">
                                        <a href="search?query=${query}&sortPrice=asc<c:if test="${types!=null}"><c:forEach items="${types}" var="t">&type=${t}</c:forEach></c:if><c:if test="${brands!=null}"><c:forEach items="${brands}" var="t">&brand=${t}</c:forEach></c:if><c:if test="${colors!=null}"><c:forEach items="${colors}" var="t">&color=${t}</c:forEach></c:if><c:if test="${priceFrom!=null}">&priceFrom=${priceFrom}</c:if><c:if test="${priceTo!=null}">&priceTo=${priceTo}</c:if>" class="sort-price__link">
                                            Price: Lowest Price
                                        </a>    
                                    </li>
                                    <li class="sort-price__item">
                                        <a href="search?query=${query}&sortPrice=desc<c:if test="${types!=null}"><c:forEach items="${types}" var="t">&type=${t}</c:forEach></c:if><c:if test="${brands!=null}"><c:forEach items="${brands}" var="t">&brand=${t}</c:forEach></c:if><c:if test="${colors!=null}"><c:forEach items="${colors}" var="t">&color=${t}</c:forEach></c:if><c:if test="${priceFrom!=null}">&priceFrom=${priceFrom}</c:if><c:if test="${priceTo!=null}">&priceTo=${priceTo}</c:if>" class="sort-price__link">
                                            Price: Highest Price
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="home-sort-bar__page">
                                ...
                                <div class="home-sort-bar__page-control">
                                    ...
                                    <a  <c:if test="${page!=numPage}" >href="search?query=${query}&page=${page+1}<c:if test="${sort!=null}">&sortPrice=${sort}</c:if><c:if test="${types!=null}"><c:forEach items="${types}" var="t">&type=${t}</c:forEach></c:if><c:if test="${brands!=null}"><c:forEach items="${brands}" var="t">&brand=${t}</c:forEach></c:if><c:if test="${colors!=null}"><c:forEach items="${colors}" var="t">&color=${t}</c:forEach></c:if><c:if test="${priceFrom!=null}">&priceFrom=${priceFrom}</c:if><c:if test="${priceTo!=null}">&priceTo=${priceTo}</c:if>"</c:if>
                                        class="home-sort-bar__page-btn">
